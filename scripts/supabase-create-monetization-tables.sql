...
INSERT INTO "AffiliateProduct" ("id", "type", "name", "description", "url", "price", "commission", "category", "platform", "active", "featured", "sortOrder", "notes", "updatedAt")
VALUES
  ('course_gestao_financas', 'course', 'Curso Gestão Financeira para Entregadores', 'Curso completo: planilha, videoaulas, suporte. Aprenda a calcular lucro real, otimizar rotas e economizar.', 'https://pay.kiwify.com.br/qUmn5jr', 97.00, 30.00, 'cursos', 'kiwify', true, true, 1, 'Checkout ativo na Kiwify; afiliados habilitados com 30% de comissão e cookie de 30 dias.', NOW()),
  ('ebook_financas_entregador', 'ebook', 'E-book: 10 Erros que Entregadores Cometem', 'Guia prático com os 10 erros mais comuns e como evitá-los. PDF de 45 páginas.', 'https://pay.kiwify.com.br/D7AebQz', 27.00, 50.00, 'ebooks', 'kiwify', true, false, 2, 'Checkout ativo na Kiwify; afiliados habilitados com 50% de comissão e cookie de 30 dias.', NOW()),
