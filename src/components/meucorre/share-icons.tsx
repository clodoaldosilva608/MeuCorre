...
// Ícones de marca pra share popup. Mantidos como componentes SVG inline
// pra não depender de fontawesome nem similar.
...
export function CheckCheck({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      style={style}
...
export function Twitter({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      style={style}
...
export function Telegram({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      style={style}
