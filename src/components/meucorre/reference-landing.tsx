  ...
  return (
    <section className="reference-landing" aria-label="Landing page MeuCorre">
      <div className="reference-landing-inner">
        ...
        <div className="reference-landing-hero">
          ...
          <div className="reference-hero-phone" aria-label="Prévia do aplicativo MeuCorre">
            ...
            <div className="reference-phone-screen">
              ...
              <div className="reference-phone-row">🎯 Metas <b>58% concluída</b></div>
        ...
        <section id="planos" className="reference-landing-section"><h2>Escolha o plano ideal para você</h2><div className="reference-card-grid three reference-pricing"><article><h3>Free</h3><p>Tudo que você precisa para começar.</p><strong>R$ 0,00</strong><small>pra sempre</small><ul><li><Check /> Corridas ilimitadas</li><li><Check /> Despesas</li><li><Check /> Metas diárias</li><li><Check /> 100% offline</li></ul><Link href={isAuthenticated ? "/app" : "/quiz"}>Usar grátis</Link></article><article className="featured"><span>MAIS ESCOLHIDO</span><h3>PRO</h3><p>Mais controle, mais análises, mais resultado.</p><strong>R$ 18,90</strong><small>/mês</small><ul><li><Check /> Tudo do plano Free</li><li><Check /> Gráficos avançados</li><li><Check /> Relatórios completos</li><li><Check /> Suporte prioritário</li></ul><button type="button" onClick={() => onCheckout("monthly")}>Testar PRO</button></article><article><h3>Vitalício</h3><p>Pague uma vez e use para sempre.</p><strong>R$ 149,90</strong><small>pagamento único</small><ul><li><Check /> Tudo do plano PRO</li><li><Check /> Atualizações vitalícias</li><li><Check /> Sem mensalidade</li><li><Check /> Acesso eterno</li></ul><button type="button" onClick={() => onCheckout("lifetime")}>Quero vitalício</button></article></div></section>
