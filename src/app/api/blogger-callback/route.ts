...
export async function GET(req: NextRequest) {
  ...
  return new NextResponse(
    ...
    <details style="margin-top:30px;text-align:left;max-width:600px;margin-left:auto;margin-right:auto;">
      ...
      <textarea readonly style="width:100%;height:100px;font-family:monospace;font-size:11px;padding:10px;margin-top:10px;border:1px solid #27272a;background:#18181b;color:#10b981;border-radius:6px;" onclick="this.select()">${code}</textarea>
    </details>
    <script>
      (function() {
