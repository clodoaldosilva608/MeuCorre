...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    if (leads.length === 0) {
      leads = [
        { name: `Restaurante Sabor da Terra - ${parsed.data.city}`, phone: null, whatsapp: null, address: `Centro, ${parsed.data.city}`, city: parsed.data.city, lat, lng, category: parsed.data.category, website: null, rating: null, reviews: null, source: "demo", instagram: null, facebook: null, email: null, openingHours: null, hasWebsite: false, hasSocialMedia: false, webDevOpportunity: true },
        { name: `Lanchonete do Bairro - ${parsed.data.city}`, phone: null, whatsapp: null, address: `Zona Sul, ${parsed.data.city}`, city: parsed.data.city, lat: lat + 0.01, lng: lng + 0.01, category: parsed.data.category, website: null, rating: null, reviews: null, source: "demo", instagram: null, facebook: null, email: null, openingHours: null, hasWebsite: false, hasSocialMedia: false, webDevOpportunity: true },
        { name: `Café Aroma - ${parsed.data.city}`, phone: null, whatsapp: null, address: `Rua das Flores, ${parsed.data.city}`, city: parsed.data.city, lat: lat - 0.01, lng: lng - 0.01, category: parsed.data.category, website: null, rating: null, reviews: null, source: "demo", instagram: null, facebook: null, email: null, openingHours: null, hasWebsite: false, hasSocialMedia: false, webDevOpportunity: true },
        { name: `Pizza Express - ${parsed.data.city}`, phone: null, whatsapp: null, address: `Av. Principal, ${parsed.data.city}`, city: parsed.data.city, lat: lat + 0.02, lng: lng - 0.01, category: parsed.data.category, website: null, rating: null, reviews: null, source: "demo", instagram: null, facebook: null, email: null, openingHours: null, hasWebsite: false, hasSocialMedia: false, webDevOpportunity: true },
        { name: `Supermercado Económico - ${parsed.data.city}`, phone: null, whatsapp: null, address: `BR-101, ${parsed.data.city}`, city: parsed.data.city, lat: lat - 0.02, lng: lng + 0.02, category: parsed.data.category, website: null, rating: null, reviews: null, source: "demo", instagram: null, facebook: null, email: null, openingHours: null, hasWebsite: false, hasSocialMedia: false, webDevOpportunity: true },
      ];
      source = "demo";
    }
